...
async def lowRL(pset: PointSet, u: Point, epsilon, dataset_name, train=False, trainning_epoch=10000, action_space_size=5, websocket=None, session_id=None):
    ...
    while True:  # stopping condition
        ...
        if choice == 1:
            ...
            pset.printMiddleSelection(num_question, "EA", h_cand[action].p1, h_cand[action].p2, 1, session_id)
        else:
